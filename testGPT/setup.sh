...
echo -e "${BLUE}Welcome to testinggpt setup!${NC}\n"
...
if docker build -t testinggpt:latest .; then
...
# Setup complete
echo -e "${GREEN}═══════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}✓ Setup complete! testinggpt is ready to use.${NC}"
echo -e "${GREEN}═══════════════════════════════════════════════════════${NC}\n"

echo -e "${BLUE}Before First Use:${NC}"
echo -e "  ${NC}1. Launch the Docker container:${NC}"
echo -e "     ${PURPLE}docker compose run --rm testinggpt${NC}\n"
...
echo -e "  ${NC}3. Run testinggpt to solve a CTF challenge:${NC}"
echo -e "     ${PURPLE}testinggpt --target 10.10.11.234${NC}\n"

echo -e "${BLUE}Quick Start:${NC}"
echo -e "  ${NC}# Solve an HTB machine${NC}"
echo -e "  ${PURPLE}docker compose run --rm testinggpt --target 10.10.11.234${NC}\n"
...
echo -e "  ${NC}# Then: testinggpt --target 10.10.11.234${NC}\n"
...
echo -e "  ${PURPLE}docker compose run --rm testinggpt --target 10.10.11.100${NC}\n"

echo -e "  ${NC}# Web CTF challenge${NC}"
echo -e "  ${PURPLE}docker compose run --rm testinggpt --target https://ctf.example.com/challenge1${NC}\n"

echo -e "  ${NC}# With challenge context${NC}"
echo -e "  ${PURPLE}docker compose run --rm testinggpt --target 10.10.11.50 --instruction \"WordPress site, look for plugin vulns\"${NC}\n"

echo -e "  ${NC}# Non-interactive mode${NC}"
echo -e "  ${PURPLE}docker compose run --rm testinggpt --target 10.10.11.234 --non-interactive${NC}\n"
